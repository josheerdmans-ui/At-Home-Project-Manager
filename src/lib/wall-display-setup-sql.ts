/** Family wall display tables (keep in sync with 20260809120000_family_wall_display.sql) */
export const WALL_DISPLAY_SETUP_SQL = `-- Family wall: members, event links, settings, routines
